...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
     ...
     */
    /**
     * Skip JWT processing for OAuth2 authorization and callback paths.
     *
     * Running the JWT filter on /oauth2/** or /login/oauth2/code/* is harmless
     * in theory (no JWT will be present), but it can interfere with Spring
     * Security's internal OAuth2 state-matching and cookie lookup on the callback,
     * particularly when combined with STATELESS session management.
     * Bypassing it on these paths is the safest approach.
     */
    @Override
